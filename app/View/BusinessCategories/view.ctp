<div class="ui-grid-d">
	...
	<div class="ui-block-b" style="width: 60%;">
		<div class="ui-corner-all custom-corners">
			<div class="ui-bar ui-bar-g"><h3><?php echo __('業種情報照会'); ?></h3></div>
			<div class="ui-body ui-body-g">
				<div class="ui-field-contain">
					<?php echo $this->Html->tag('label',__('名称'),array('style' => 'width: 30%;')); ?>
					<?php echo $this->Html->tag('label',$record['BusinessCategory']['name'],array('style' => 'width: 30%;')); ?>
				</div>
				<?php echo $this->Html->div(NULL, NULL, array('style' => 'text-align: center;')); ?>
					...
					<?php echo $this->Html->link(__('編集'), array('controller' => 'BusinessCategories', 'action' => 'edit', $record['BusinessCategory']['_id']), array('class' => array('ui-btn', 'ui-mini', 'ui-corner-all', 'ui-btn-inline', 'ui-icon-flat-eye', 'ui-btn-icon-left', 'ui-btn-b'))); ?>
