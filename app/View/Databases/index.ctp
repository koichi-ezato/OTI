<div class="ui-corner-all custom-corners">
	<div class="ui-bar ui-bar-g"><h3><?php echo __('データベース一覧'); ?></h3></div>
	<div class="ui-body ui-body-g">
		<?php echo $this->Form->create('Databases', array('type' => 'post')); ?>
			...
			<?php echo $this->Html->link(__('新規'), array('controller' => 'Databases', 'action' => 'add'), array('class' => array('ui-btn', 'ui-mini', 'ui-corner-all', 'ui-btn-inline', 'ui-icon-flat-plus', 'ui-btn-icon-left', 'ui-btn-g'))); ?>
...
<table class="table-stripe">
	...
	<tbody>
		...
		<tr>
			<td style="text-align: center;"><?php echo $this->Html->link(__('照会'), array('controller' => 'Databases', 'action' => 'view', $value['Database']['_id']), array('class' => array('ui-btn', 'ui-mini', 'ui-corner-all', 'ui-btn-inline', 'ui-icon-flat-eye', 'ui-btn-icon-left', 'ui-btn-b'))); ?></td>
			<td><?php echo $value['Database']['name']; ?></td>
		</tr>
		<?php endforeach; ?>
		<?php endif; ?>
	</tbody>
